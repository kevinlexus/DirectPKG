create or replace package scott.p_meter is
  ...
  procedure imp_states_meter(p_lsk in varchar2, p_klsk_met in number, p_usl in varchar2) ;
  procedure imp_lsk_meter(p_lsk in kart.lsk%type, p_usl_hw in varchar2, p_usl_gw in varchar2, p_usl_el in varchar2, p_usl_ot in varchar2);
