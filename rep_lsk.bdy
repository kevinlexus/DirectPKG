...
/*         select '201401' as mg_ord, '201401' as mg1, 10 as curdays, 111 as penyar, 100.10 as summa2, 3030.98 as penya, 11 as partrate,
             11 as rate , gdt(0,0,0) as dt1, gdt(0,0,0) as dt2, 10 as fk_stav from dual;
*/
